...
function UseTrendLineFn(
    ...
    function drawLine(firstPointRef : point , secondPointRef : point , options?: ILineOptions) {
        const trendLine = new TrendLine(chartRef.current, candleStickSeriesRef.current, firstPointRef, secondPointRef , {
