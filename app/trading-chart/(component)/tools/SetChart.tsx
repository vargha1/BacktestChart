...
type ChartEntry = {
  title: string;
  type: "bar" | "candlestick" | "line" | "area";
  icon: React.ReactNode;
};

const charts: ChartEntry[] = [
  { title: "Bars", type: "bar", icon: <IconBarsChart /> },
  { title: "Candles", type: "candlestick", icon: <IconCandleChart /> },
  { title: "Line", type: "line", icon: <IconLineChart /> },
  { title: "Area", type: "area", icon: <IconAreaChart /> },
];
            ...
            {charts.map((series, index: number) => (
              <li key={index}>
                <div className="flex">
                  <ButtonComponent
                    text={series.icon}
                    onclick={() => setSelectedType(series.type)}
                  />
                  <ButtonComponent
                    text={series.title}
                    onclick={() => setSelectedType(series.type)}
